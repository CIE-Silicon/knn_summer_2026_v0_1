 ...
 reg deq_holdin;
    ...
    begin: InitMemory
        ...
        begin
           ...
           $display("s25fl128s: InitMemory done. UserPreload=%0d mem_file_name=%s Mem[0]=%02h",
                    UserPreload, mem_file_name, Mem[0]);
        end
                    ...
                    begin
                        ...
                        begin
                            ...
                            begin
                                ...
                                SOut_zd  = data_out[7-read_cnt];
                                 $display("s25fl128s READ: time=%0t addr=0x%06h Mem=%02h data_out=%02h read_cnt=%0d",
                                         $time, read_addr, Mem[read_addr], data_out, read_cnt);
